...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/R-home-screen.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio-settings.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio-theme.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio_windows.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio_newscript.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio_scripts.png}}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"C:/Users/geogcd/Documents/cbsi\_r\_training"}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio-setwd.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/functions-help.png}}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{9} \DecValTok{2} \DecValTok{7}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{6} \DecValTok{987}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}
\NormalTok{ [}\DecValTok{49}\NormalTok{]  }\ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{336} \DecValTok{121} \DecValTok{343} \DecValTok{430} \DecValTok{229} \DecValTok{987} \DecValTok{676} \DecValTok{566} \DecValTok{911} \DecValTok{748} \DecValTok{203} \DecValTok{310} \DecValTok{656} \DecValTok{837} \DecValTok{363} \DecValTok{537} \DecValTok{829} \DecValTok{226} \DecValTok{595}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{373} \DecValTok{269} \DecValTok{787} \DecValTok{934} \DecValTok{777} \DecValTok{735} \DecValTok{463} \DecValTok{481} \DecValTok{470} \DecValTok{800} \DecValTok{701} \DecValTok{191} \DecValTok{703} \DecValTok{772} \DecValTok{914} \DecValTok{902} \DecValTok{125} \DecValTok{886} \DecValTok{810}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{447} \DecValTok{975} \DecValTok{908} \DecValTok{771} \DecValTok{907} \DecValTok{963} \DecValTok{246} \DecValTok{143} \DecValTok{951} \DecValTok{435} \DecValTok{227} \DecValTok{176} \DecValTok{634} \DecValTok{794} \DecValTok{475} \DecValTok{539} \DecValTok{826} \DecValTok{952} \DecValTok{715}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{671} \DecValTok{927} \DecValTok{679} \DecValTok{118} \DecValTok{949} \DecValTok{192} \DecValTok{574} \DecValTok{100} \DecValTok{383} \DecValTok{821} \DecValTok{957} \DecValTok{594} \DecValTok{647} \DecValTok{262} \DecValTok{948} \DecValTok{486} \DecValTok{346} \DecValTok{236} \DecValTok{153}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{610} \DecValTok{890} \DecValTok{652} \DecValTok{779} \DecValTok{272} \DecValTok{292} \DecValTok{294} \DecValTok{544} \DecValTok{700} \DecValTok{163} \DecValTok{518} \DecValTok{711} \DecValTok{223}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{87} \DecValTok{86} \DecValTok{72}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio-packages.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio-base-package.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/rstudio-install-package.png}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(readr)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}readr\textquotesingle{}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/databrew/intro{-}to{-}data{-}science/main/data/deaths.csv"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"read\_csv"}
\NormalTok{df}
\NormalTok{  age   home     name instrument x\_factor}
\DecValTok{1}  \DecValTok{33}\NormalTok{ Canada      Ben  Nose harp        }\DecValTok{3}
\DecValTok{2}  \DecValTok{35}\NormalTok{  Spain      Joe Concertina       }\DecValTok{20}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/csv.png}}
A neat spreadsheet of rows and columns.

When you open up this same dataset in a simple text editor, it looks like this:

\pandocbounded{\includegraphics[keepaspectratio]{docs/img/csv_text_editor.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/csv_dont.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/csv_do.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/csv_wd.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/project_template.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-207-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-209-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-210-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-213-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-215-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-216-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-217-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-218-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-219-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-220-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-221-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-222-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-224-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-225-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/unnamed-chunk-227-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{docs/img/ggplot.png}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(ggplot2)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}ggplot2\textquotesingle{}}
\FunctionTok{library}\NormalTok{(readr)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(readr)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}readr\textquotesingle{}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(dplyr)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}dplyr\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{()}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"ggplot"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ titanic, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Fare))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"ggplot"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ titanic, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Age, }\AttributeTok{y =}\NormalTok{ Fare, }\AttributeTok{color =}\NormalTok{ Sex))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"ggplot"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}p\textquotesingle{}}\NormalTok{ not found}
\NormalTok{p}
\NormalTok{Error}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}p\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ titanic, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Sex))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"ggplot"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}titanic\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}mean\_age\_males\textquotesingle{}}\NormalTok{ not found}
\CommentTok{\# Plot it}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ titanic\_age, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Sex, }\AttributeTok{y =}\NormalTok{ mean\_age))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"ggplot"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ titanic }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(Sex, Survived) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarise}\NormalTok{(}\AttributeTok{mean\_age =} \FunctionTok{mean}\NormalTok{(Age, }\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ titanic\_em }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Survived =} \FunctionTok{ifelse}\NormalTok{(Survived }\SpecialCharTok{==} \DecValTok{1}\NormalTok{, }\StringTok{"Survived"}\NormalTok{, }\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}

\CommentTok{\# Check it out}
\NormalTok{titanic\_em}
\NormalTok{Error}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}titanic\_em\textquotesingle{}}\NormalTok{ not found}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ titanic\_em, }
  ...
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat=}\StringTok{\textquotesingle{}identity\textquotesingle{}}\NormalTok{)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ titanic\_em, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Sex, }\AttributeTok{y =}\NormalTok{ mean\_age, }\AttributeTok{fill =}\NormalTok{ Survived))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"ggplot"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{seq}\NormalTok{(}\DecValTok{10}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{2}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ head }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ sum }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ sqrt}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{100} \SpecialCharTok{\%\textgreater{}\%}\NormalTok{ sd }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ mean}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(sex }\SpecialCharTok{==} \StringTok{"Male"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(sex }\SpecialCharTok{==} \StringTok{"Female"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(sex }\SpecialCharTok{==} \StringTok{"Female"} \SpecialCharTok{\&}\NormalTok{ age }\SpecialCharTok{\textless{}} \DecValTok{33}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(sex }\SpecialCharTok{==} \StringTok{"Female"}\NormalTok{, age }\SpecialCharTok{\textless{}} \DecValTok{33}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(sex }\SpecialCharTok{==} \StringTok{"Female"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{filter}\NormalTok{(age }\SpecialCharTok{\textless{}} \DecValTok{33}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(age)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(sex)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(who)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(}\FunctionTok{desc}\NormalTok{(age))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{arrange}\NormalTok{(sex, age)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(age)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(sex, age)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(sex, }\AttributeTok{years =}\NormalTok{ age)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(who}\SpecialCharTok{:}\NormalTok{sex)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rename}\NormalTok{(}\AttributeTok{gender =}\NormalTok{ sex, }\AttributeTok{years =}\NormalTok{ age, }\AttributeTok{first\_name =}\NormalTok{ who)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{agein2020 =}\NormalTok{ age }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{is\_male =}\NormalTok{ sex }\SpecialCharTok{==} \StringTok{"Male"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{average\_age =} \FunctionTok{mean}\NormalTok{(age))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{average\_age =} \FunctionTok{mean}\NormalTok{(age)) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{diff\_from\_avg =}\NormalTok{ age }\SpecialCharTok{{-}} \ErrorTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{age =} \ConstantTok{NULL}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{transmute}\NormalTok{(}\AttributeTok{average\_age =} \FunctionTok{mean}\NormalTok{(age))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(sex) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{average\_age\_for\_sex =} \FunctionTok{mean}\NormalTok{(age))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(sex) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{average\_age\_for\_sex =} \FunctionTok{mean}\NormalTok{(age)) }\SpecialCharTok{\%\textgreater{}\%} \ErrorTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarize}\NormalTok{(}\AttributeTok{average\_age =} \FunctionTok{mean}\NormalTok{(age))}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarize}\NormalTok{(}\AttributeTok{average\_age =} \FunctionTok{mean}\NormalTok{(age), }\AttributeTok{standard\_dev\_of\_age =} \FunctionTok{sd}\NormalTok{(age), }\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(sex) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarise}\NormalTok{(}\AttributeTok{avg\_age =} \FunctionTok{mean}\NormalTok{(age), }\AttributeTok{oldest\_age =} \FunctionTok{max}\NormalTok{(age), }\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ people }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{group\_by}\NormalTok{(sex) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{summarise}\NormalTok{(}\AttributeTok{sample\_size =} \FunctionTok{n}\NormalTok{())}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"\%\textgreater{}\%"}
\end{Highlighting}
\end{Shaded}
