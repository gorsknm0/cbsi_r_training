...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"C:/Users/htzt324/OneDrive {-} University of Leeds/Desktop/Nika/CongoFor1.5/bRazzaville\_training"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{8} \DecValTok{5} \DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]    }\DecValTok{8} \DecValTok{1000}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}
\NormalTok{ [}\DecValTok{97}\NormalTok{] }\ConstantTok{FALSE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{]  }\DecValTok{219}  \DecValTok{428}  \DecValTok{626}  \DecValTok{681}  \DecValTok{703}  \DecValTok{732}  \DecValTok{375}  \DecValTok{130}  \DecValTok{420}  \DecValTok{192}  \DecValTok{142}  \DecValTok{377}  \DecValTok{527}  \DecValTok{913}  \DecValTok{969}
\NormalTok{[}\DecValTok{16}\NormalTok{]  }\DecValTok{897}  \DecValTok{616}  \DecValTok{330}  \DecValTok{260}  \DecValTok{757}  \DecValTok{929} \DecValTok{1000}  \DecValTok{783}  \DecValTok{203}  \DecValTok{503}  \DecValTok{821}  \DecValTok{522}  \DecValTok{865}  \DecValTok{484}  \DecValTok{600}
\NormalTok{[}\DecValTok{31}\NormalTok{]  }\DecValTok{723}  \DecValTok{426}  \DecValTok{926}  \DecValTok{302}  \DecValTok{698}  \DecValTok{835}  \DecValTok{368}  \DecValTok{826}  \DecValTok{854}  \DecValTok{746}  \DecValTok{701}  \DecValTok{498}  \DecValTok{476}  \DecValTok{905}  \DecValTok{612}
\NormalTok{[}\DecValTok{46}\NormalTok{]  }\DecValTok{360}  \DecValTok{593}  \DecValTok{705}  \DecValTok{883}  \DecValTok{889}  \DecValTok{359}  \DecValTok{882}  \DecValTok{532}  \DecValTok{533}  \DecValTok{534}  \DecValTok{443}  \DecValTok{767}  \DecValTok{536}  \DecValTok{954}  \DecValTok{836}
\NormalTok{[}\DecValTok{61}\NormalTok{]  }\DecValTok{868}  \DecValTok{912}  \DecValTok{264}  \DecValTok{310}  \DecValTok{165}  \DecValTok{552}  \DecValTok{478}  \DecValTok{386}  \DecValTok{131}  \DecValTok{523}  \DecValTok{959}  \DecValTok{371}  \DecValTok{942}  \DecValTok{316}  \DecValTok{909}
\NormalTok{[}\DecValTok{76}\NormalTok{]  }\DecValTok{632}  \DecValTok{880}  \DecValTok{991}  \DecValTok{818}  \DecValTok{870}  \DecValTok{307}  \DecValTok{297}  \DecValTok{195}  \DecValTok{863}  \DecValTok{106}  \DecValTok{793}  \DecValTok{704}  \DecValTok{608}  \DecValTok{275}  \DecValTok{807}
\NormalTok{[}\DecValTok{91}\NormalTok{]  }\DecValTok{844}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{83}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"s!Efq{-}+}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{G6\textgreater{}UiQ\textasciitilde{}5I:o \{7\#}\SpecialCharTok{\textbackslash{}"}\StringTok{"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"zVs;Ik*b{-}LPqHN!$UKidg5\}}\SpecialCharTok{\textbackslash{}"}\StringTok{"}
\end{Highlighting}
\end{Shaded}
