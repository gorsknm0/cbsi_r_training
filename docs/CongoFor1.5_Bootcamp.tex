...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"C:/Users/htzt324/OneDrive {-} University of Leeds/Desktop/Nika/CongoFor1.5/cbsi\_r\_training"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{9} \DecValTok{2} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]  }\DecValTok{11} \DecValTok{997}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{37}\NormalTok{] }\ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{412} \DecValTok{581} \DecValTok{188} \DecValTok{445} \DecValTok{478} \DecValTok{223}  \DecValTok{98} \DecValTok{966} \DecValTok{709} \DecValTok{516} \DecValTok{224} \DecValTok{545} \DecValTok{669} \DecValTok{335} \DecValTok{528} \DecValTok{120} \DecValTok{323} \DecValTok{938} \DecValTok{630}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{409} \DecValTok{848} \DecValTok{210} \DecValTok{710} \DecValTok{331}  \DecValTok{94} \DecValTok{240} \DecValTok{979} \DecValTok{730} \DecValTok{917} \DecValTok{841} \DecValTok{319} \DecValTok{722}  \DecValTok{97} \DecValTok{897} \DecValTok{662} \DecValTok{615} \DecValTok{534} \DecValTok{734}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{842} \DecValTok{385} \DecValTok{435} \DecValTok{198} \DecValTok{895} \DecValTok{823} \DecValTok{326} \DecValTok{933} \DecValTok{413} \DecValTok{899} \DecValTok{402} \DecValTok{216} \DecValTok{584} \DecValTok{910} \DecValTok{242} \DecValTok{671} \DecValTok{171} \DecValTok{806} \DecValTok{237}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{997} \DecValTok{360} \DecValTok{573} \DecValTok{225} \DecValTok{182} \DecValTok{733} \DecValTok{805} \DecValTok{652} \DecValTok{117} \DecValTok{717} \DecValTok{666} \DecValTok{987} \DecValTok{627} \DecValTok{146} \DecValTok{845} \DecValTok{916} \DecValTok{513} \DecValTok{518} \DecValTok{650}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{703} \DecValTok{282} \DecValTok{659} \DecValTok{661} \DecValTok{213} \DecValTok{105} \DecValTok{898} \DecValTok{189} \DecValTok{438} \DecValTok{954} \DecValTok{205} \DecValTok{112} \DecValTok{287} \DecValTok{859} \DecValTok{566} \DecValTok{765} \DecValTok{688}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{79}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"\textquotesingle{})RT\}Xv,\%+MiD z6\textasciitilde{}\{{-}slckN"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"V;\textgreater{}\}Q\{S0e\textless{}Cag9)tU3P/f]?4"}
\end{Highlighting}
\end{Shaded}
