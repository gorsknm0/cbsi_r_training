...
You can use this simple data file, `r xfun::embed_file('data/super_data.csv',text="super_data.csv")`, to practice.
...
For example, `r xfun::embed_file('data/super_data.rds',text="super_data.rds")`contains a `tibble` version of the dataframe above. When you read in that `.rds` file, it is already formatted as a `tibble`: 
